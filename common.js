...
setupGoogleCalendarIframe () {
    ...
    if (title.includes('【スケジュール】') || page_url == 'https://seesaawiki.jp/ssrb/') {
        ...
        new_element.src = 'https://calendar.google.com/calendar/embed?height=600&wkst=1&bgcolor=%23FFFFFF&ctz=Asia%2FTokyo&showTitle=0&showPrint=0&showTz=0&showCalendars=1&showNav=1&showDate=1&mode=AGENDA&src=cGM2ODAxc3JAZ21haWwuY29t&color=%230000FF'
